...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    DriftCommunication$(_channel, debugLog, serialize) {
      var t1 = new A.DriftCommunication(_channel, false, serialize, A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$._PendingRequest), A.StreamController_StreamController(null, null, true, type$.Request), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void));
      t1.DriftCommunication$3$debugLog$serialize(_channel, false, serialize);
      return t1;
    },
    DriftCommunication: function DriftCommunication(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._channel = t0;
      _._debugLog = t1;
      _._serialize = t2;
    ...
    WebProtocol_deserialize_decodeRequest: function WebProtocol_deserialize_decodeRequest(t0, t1) {
      this._box_0 = t0;
      this.$this = t1;
    },
    WebProtocol_deserialize_decodeSuccess: function WebProtocol_deserialize_decodeSuccess(t0, t1) {
      this._box_0 = t0;
      this.$this = t1;
    },
    WebProtocol__serializeRequest_closure: function WebProtocol__serializeRequest_closure() {
    },
    WebProtocol__deserializeRequest_readBatched: function WebProtocol__deserializeRequest_readBatched(t0, t1) {
      this.$this = t0;
      this.dartList = t1;
    },
    WebProtocol__deserializeRequest_readBatched_closure: function WebProtocol__deserializeRequest_readBatched_closure() {
    },
    WebProtocol__deserializeRequest_readBatched_closure0: function WebProtocol__deserializeRequest_readBatched_closure0() {
    },
    WebProtocol__deserializeRequest_closure: function WebProtocol__deserializeRequest_closure() {
    },
    WebProtocol__serializeSelectResult_closure: function WebProtocol__serializeSelectResult_closure() {
    },
    WebProtocol__deserializeResponse_closure: function WebProtocol__deserializeResponse_closure() {
    },
    ...
    WebPortToChannel_channel(_this, explicitClose, nativeSerializionVersion, webNativeSerialization) {
      ...
      protocol = new A.WebProtocol(A.ProtocolVersion_negotiate(nativeSerializionVersion));
      _this.onmessage = A._functionToJS1(new A.WebPortToChannel_channel_closure(explicitClose, controller, webNativeSerialization, protocol));
      t4 = t4.__GuaranteeChannel__streamController_F;
      t4 === $ && A.throwLateFieldNI("_streamController");
      new A._ControllerStream(t4, A._instanceType(t4)._eval$1("_ControllerStream<1>")).listen$2$onDone(new A.WebPortToChannel_channel_closure0(webNativeSerialization, protocol, _this), new A.WebPortToChannel_channel_closure1(explicitClose, _this));
      return t1;
    },
    ...
    driftDatabase($name, native, web) {
      var t1 = A.ArgumentError$("When compiling to the web, the `web` parameter needs to be set.", null);
      throw A.wrapException(t1);
    },
    current() {
  ...
  A.IndexedIterable.prototype = {
    ...
    get$first(_) {
      return new A._Record_2(this._start, J.get$first$ax(this.__internal$_source));
    },
    elementAt$1(_, index) {
      return new A._Record_2(index + this._start, J.elementAt$1$ax(this.__internal$_source, index));
    },
    skip$1(_, count) {
      A.ArgumentError_checkNotNull(count, "count", type$.int);
      A.RangeError_checkNotNegative(count, "count");
      return new A.IndexedIterable(J.skip$1$ax(this.__internal$_source, count), count + this._start, A._instanceType(this)._eval$1("IndexedIterable<1>"));
    },
    get$iterator(_) {
      return new A.IndexedIterator(J.get$iterator$ax(this.__internal$_source), this._start, A._instanceType(this)._eval$1("IndexedIterator<1>"));
    }
  };
  A.EfficientLengthIndexedIterable.prototype = {
    ...
    skip$1(_, count) {
      A.ArgumentError_checkNotNull(count, "count", type$.int);
      A.RangeError_checkNotNegative(count, "count");
      return new A.EfficientLengthIndexedIterable(J.skip$1$ax(this.__internal$_source, count), this._start + count, this.$ti);
    },
    $isEfficientLengthIterable: 1
  };
  A.IndexedIterator.prototype = {
    moveNext$0() {
      if (++this.__internal$_index >= 0 && this.__internal$_source.moveNext$0())
        return true;
    ...
    get$current() {
      ...
      return t1 >= 0 ? new A._Record_2(this._start + t1, this.__internal$_source.get$current()) : A.throwExpression(A.IterableElementError_noElement());
    },
    $isIterator: 1
  };
  ...
  A._DoneStreamSubscription.prototype = {
    ...
    onDone$1(handleDone) {
      ...
      if (this._state >= 0)
        this._onDone = handleDone != null ? this._zone.registerCallback$1$1(handleDone, type$.void) : handleDone;
    },
    pause$1(resumeSignal) {
      var t1 = this._state;
      if (t1 >= 0)
  ...
  A.SubscriptionStream.prototype = {
    SubscriptionStream$1(subscription, $T) {
      var source = this._subscription_stream$_source;
      source.pause$0();
      source.onData$1(null);
      source.onError$1(null);
  ...
  A._CancelOnErrorSubscriptionWrapper_onError__closure.prototype = {
    call$0() {
      ...
      if (type$.dynamic_Function_Object_StackTrace._is(t1))
  ...
  A.DriftCommunication.prototype = {
    DriftCommunication$3$debugLog$serialize(_channel, debugLog, serialize) {
      this._channel.get$stream().listen$2$onDone(this.get$_communication$_handleMessage(), new A.DriftCommunication_closure(this));
    },
    newRequestId$0() {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$self._channel.get$sink().close$0();
              $async$goto = 3;
    ...
    _send$1(msg) {
      ...
      t1 = _this._channel.get$sink();
      t1.add$1(0, _this._serialize ? B.C_DriftProtocol.serialize$1(msg) : msg);
    },
  ...
  A.DriftCommunication_closure.prototype = {
    call$0() {
      var t1, t2, t3;
      for (t1 = this.$this, t2 = t1._pendingRequests, t3 = new A.LinkedHashMapValueIterator(t2, t2.__js_helper$_modifications, t2.__js_helper$_first, A._instanceType(t2)._eval$1("LinkedHashMapValueIterator<2>")); t3.moveNext$0();)
  ...
  A.DriftProtocol.prototype = {
    ...
    decodePayload$1(encoded) {
      var t1, tag, readInt, readNullableInt, method, sql, args, t2, i, list, t3, t4, t5, _1_0, updates, encodedUpdate, _2_0, columnCount, columns, rows, result, rowOffset, c, _null = null, _box_0 = {};
      if (encoded == null)
        return _null;
      ...
      switch (tag) {
        ...
        case 13:
          t1.toString;
          return new A.ServerInfo(A.EnumByName_byName(B.List_nVg, A._asString(J.$index$asx(t1, 1)), type$.SqlDialect));
        case 7:
        ...
        case 11:
          ...
          for (t1 = 3 + columnCount, t3 = type$.nullable_Object, i = 0; i < rows; ++i) {
            rowOffset = t1 + i * columnCount;
            t4 = A.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
            for (c = 0; c < columnCount; ++c)
              t4.$indexSet(0, columns.$index(0, c), this._decodeDbValue$1(J.$index$asx(_box_0.fullMessage, rowOffset + c)));
  ...
  A.ServerImplementation.prototype = {
    ...
    serve$1(channel) {
      ...
      comm = A.DriftCommunication$(channel, false, true);
    ...
    _closeRemainingConnections$0() {
      var t1, t2, t3;
      for (t1 = this._activeChannels, t1 = A._LinkedHashSetIterator$(t1, t1._modifications, A._instanceType(t1)._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 11:
              // then
              $async$goto = 13;
              return A._asyncAwait(executor.close$0(), $async$_transactionControl$3);
            case 13:
              // returning from await.
              executorId.toString;
  ...
  A.WebProtocol.prototype = {
    serialize$1(message) {
      var t1, _1_5_isSet, _1_8, _1_9, _1_9_isSet, e, stackTrace, _1_5, requestId, _this0, t2, _this1, t3, t4, _0_0, t5, t6, _i, _this = this, _null = null;
      $label0$0: {
        if (message instanceof A.Request) {
          t1 = new A._Record_2(0, {i: message.id, p: _this._serializeRequest$1(message.payload)});
          break $label0$0;
        }
        if (message instanceof A.SuccessResponse) {
          t1 = new A._Record_2(1, {i: message.requestId, p: _this._serializeResponse$1(message.response)});
          break $label0$0;
        }
        _1_5_isSet = message instanceof A.ErrorResponse;
        _1_8 = _null;
        _1_9 = _null;
        _1_9_isSet = false;
        e = _null;
        ...
        t1 = false;
        if (_1_5_isSet) {
          _1_5 = message.requestId;
          _1_8 = message.error;
          _1_9_isSet = _1_8 instanceof A.SqliteException;
          if (_1_9_isSet) {
            type$.SqliteException._as(_1_8);
            _1_9 = message.stackTrace;
            t1 = _this._protocolVersion.versionCode >= 4;
            stackTrace = _1_9;
            e = _1_8;
          }
          requestId = _1_5;
        ...
        if (t1) {
          t1 = stackTrace == null ? _null : stackTrace.toString$0(0);
          _this0 = e.message;
          t2 = e.explanation;
          if (t2 == null)
            t2 = _null;
          _this1 = e.extendedResultCode;
          t3 = e.operation;
          if (t3 == null)
            t3 = _null;
          t4 = e.causingStatement;
          if (t4 == null)
            t4 = _null;
          _0_0 = e.parametersToStatement;
          $label1$1: {
            if (_0_0 == null) {
              t5 = _null;
              break $label1$1;
            ...
            t5 = [];
            for (t6 = _0_0.length, _i = 0; _i < _0_0.length; _0_0.length === t6 || (0, A.throwConcurrentModificationError)(_0_0), ++_i)
              t5.push(_this._web_protocol$_encodeDbValue$1(_0_0[_i]));
            break $label1$1;
          }
          t5 = new A._Record_2(4, [requestId, t1, _this0, t2, _this1, t3, t4, t5]);
          t1 = t5;
          break $label0$0;
        }
        if (_1_5_isSet) {
          stackTrace = _1_9_isSet ? _1_9 : message.stackTrace;
          _this = J.toString$0$(_1_8);
          t1 = new A._Record_2(2, [_1_5, _this, stackTrace == null ? _null : stackTrace.toString$0(0)]);
          break $label0$0;
        }
        if (message instanceof A.CancelledResponse) {
          t1 = new A._Record_2(3, message.requestId);
          break $label0$0;
        }
        t1 = _null;
      }
      return A._setArrayType([t1._0, t1._1], type$.JSArray_Object);
    },
    deserialize$1(message) {
      var t1, tag, t2, error, stackTrace, requestId, _this = this, _null = null,
        _s22_ = "Pattern matching error",
        _box_0 = {};
      _box_0.payload = null;
      t1 = message.length === 2;
      if (t1) {
        if (0 < 0 || 0 >= message.length)
          return A.ioore(message, 0);
        tag = message[0];
        if (1 < 0 || 1 >= message.length)
          return A.ioore(message, 1);
        t2 = _box_0.payload = message[1];
      } else {
        t2 = _null;
        tag = t2;
      }
      ...
      tag = A._asInt(A._asDouble(tag));
      $label0$0: {
        if (0 === tag) {
          t1 = new A.WebProtocol_deserialize_decodeRequest(_box_0, _this).call$0();
          break $label0$0;
        }
        if (1 === tag) {
          t1 = new A.WebProtocol_deserialize_decodeSuccess(_box_0, _this).call$0();
          break $label0$0;
        }
        if (2 === tag) {
          type$.JSArray_nullable_Object._as(t2);
          t1 = t2.length === 3;
          error = _null;
          stackTrace = _null;
          if (t1) {
            ...
            requestId = _null;
          if (!t1)
            A.throwExpression(A.StateError$(_s22_));
          t1 = new A.ErrorResponse(A._asInt(A._asDouble(requestId)), A._asString(error), _this._decodeStackStrace$1(stackTrace));
          break $label0$0;
        }
        if (4 === tag) {
          t1 = _this._decodeSqliteErrorResponse$1(type$.JSArray_nullable_Object._as(t2));
          break $label0$0;
        }
        if (3 === tag) {
          t1 = new A.CancelledResponse(A._asInt(A._asDouble(t2)));
          break $label0$0;
        }
        t1 = A.throwExpression(A.ArgumentError$("Unknown message tag " + tag, _null));
      }
      return t1;
    },
    _serializeRequest$1(payload) {
      var t1, _this, t2, t3, t4, _i, arg, t5, t6, _i0, update, _null = null;
      $label0$0: {
        t1 = _null;
        if (payload == null)
          break $label0$0;
        if (payload instanceof A.ExecuteQuery) {
          t1 = payload.method;
          _this = payload.sql;
          t2 = [];
          for (t3 = payload.args, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, A.throwConcurrentModificationError)(t3), ++_i)
            t2.push(this._web_protocol$_encodeDbValue$1(t3[_i]));
          t3 = payload.executorId;
          if (t3 == null)
            t3 = _null;
          t3 = [3, t1.index, _this, t2, t3];
          t1 = t3;
          break $label0$0;
        }
        if (payload instanceof A.RequestCancellation) {
          t1 = A._setArrayType([12, payload.originalRequestId], type$.JSArray_double);
          break $label0$0;
        }
        if (payload instanceof A.ExecuteBatchedStatement) {
          t1 = payload.stmts;
          t2 = J.map$1$1$ax(t1.statements, new A.WebProtocol__serializeRequest_closure(), type$.String);
          ...
          for (t1 = t1.$arguments, t3 = t1.length, _i = 0; _i < t1.length; t1.length === t3 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
            ...
            t4 = [arg.statementIndex];
            for (t5 = arg.$arguments, t6 = t5.length, _i0 = 0; _i0 < t5.length; t5.length === t6 || (0, A.throwConcurrentModificationError)(t5), ++_i0)
              t4.push(this._web_protocol$_encodeDbValue$1(t5[_i0]));
            t2.push(t4);
          }
          t1 = payload.executorId;
          t2.push(t1 == null ? _null : t1);
          t1 = t2;
          break $label0$0;
        }
        if (payload instanceof A.RunNestedExecutorControl) {
          t1 = payload.control;
          t2 = payload.executorId;
          if (t2 == null)
            t2 = _null;
          t2 = A._setArrayType([5, t1.index, t2], type$.JSArray_nullable_double);
          t1 = t2;
          break $label0$0;
        }
        if (payload instanceof A.EnsureOpen) {
          _this = payload.schemaVersion;
          t1 = payload.executorId;
          t1 = A._setArrayType([6, _this, t1 == null ? _null : t1], type$.JSArray_nullable_double);
          break $label0$0;
        }
        if (payload instanceof A.ServerInfo) {
          t1 = A._setArrayType([13, payload.dialect._name], type$.JSArray_Object);
          break $label0$0;
        }
        if (payload instanceof A.RunBeforeOpen) {
          t1 = payload.details;
          t2 = t1.versionBefore;
          if (t2 == null)
            t2 = _null;
          t1 = A._setArrayType([7, t2, t1.versionNow, payload.createdExecutor], type$.JSArray_nullable_double);
          break $label0$0;
        }
        if (payload instanceof A.NotifyTablesUpdated) {
          t1 = [8];
          for (t2 = payload.updates, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
            update = t2[_i];
            t4 = update.kind;
            t4 = t4 == null ? _null : t4.index;
            t1.push([update.table, t4]);
          }
          break $label0$0;
        }
        if (B.NoArgsRequest_0 === payload) {
          t1 = 0;
          break $label0$0;
        }
      }
    ...
    _deserializeRequest$1(payload) {
      var t1, tag, t2, t3, t4, t, _null = null;
      if (payload == null)
        return _null;
      ...
      t1._as(payload);
      if (0 < 0 || 0 >= payload.length)
        return A.ioore(payload, 0);
      tag = A._asInt(A._asDouble(payload[0]));
      $label0$0: {
        if (3 === tag) {
          if (1 < 0 || 1 >= payload.length)
            return A.ioore(payload, 1);
          t2 = A._asInt(A._asDouble(payload[1]));
          if (!(t2 >= 0 && t2 < 4))
            return A.ioore(B.List_s6K, t2);
          t2 = B.List_s6K[t2];
          if (2 < 0 || 2 >= payload.length)
            return A.ioore(payload, 2);
          t3 = A._asString(payload[2]);
          t4 = [];
          if (3 < 0 || 3 >= payload.length)
            return A.ioore(payload, 3);
          t = t1._as(payload[3]);
          t1 = B.JSArray_methods.get$iterator(t);
          while (t1.moveNext$0())
            t4.push(this._web_protocol$_decodeDbValue$1(t1.get$current()));
          if (4 < 0 || 4 >= payload.length)
            return A.ioore(payload, 4);
          t1 = payload[4];
          t1 = new A.ExecuteQuery(t2, t3, t4, t1 == null ? _null : A._asInt(A._asDouble(t1)));
          break $label0$0;
        }
        if (12 === tag) {
          if (1 < 0 || 1 >= payload.length)
            return A.ioore(payload, 1);
          t1 = new A.RequestCancellation(A._asInt(A._asDouble(payload[1])));
          break $label0$0;
        }
        if (4 === tag) {
          t1 = new A.WebProtocol__deserializeRequest_readBatched(this, payload).call$0();
          break $label0$0;
        }
        if (5 === tag) {
          if (1 < 0 || 1 >= payload.length)
            return A.ioore(payload, 1);
          t1 = A._asInt(A._asDouble(payload[1]));
          if (!(t1 >= 0 && t1 < 5))
            return A.ioore(B.List_ttt, t1);
          t1 = B.List_ttt[t1];
          if (2 < 0 || 2 >= payload.length)
            return A.ioore(payload, 2);
          t2 = payload[2];
          t1 = new A.RunNestedExecutorControl(t1, t2 == null ? _null : A._asInt(A._asDouble(t2)));
          break $label0$0;
        }
        if (6 === tag) {
          if (1 < 0 || 1 >= payload.length)
          ...
          if (2 < 0 || 2 >= payload.length)
            return A.ioore(payload, 2);
          t2 = payload[2];
          t1 = new A.EnsureOpen(t1, t2 == null ? _null : A._asInt(A._asDouble(t2)));
          break $label0$0;
        }
        if (13 === tag) {
          if (1 < 0 || 1 >= payload.length)
            return A.ioore(payload, 1);
          t1 = new A.ServerInfo(A.EnumByName_byName(B.List_nVg, A._asString(payload[1]), type$.SqlDialect));
          break $label0$0;
        }
        if (7 === tag) {
          if (1 < 0 || 1 >= payload.length)
            return A.ioore(payload, 1);
          t1 = payload[1];
          t1 = t1 == null ? _null : A._asInt(A._asDouble(t1));
          if (2 < 0 || 2 >= payload.length)
            return A.ioore(payload, 2);
          t2 = A._asInt(A._asDouble(payload[2]));
          if (3 < 0 || 3 >= payload.length)
            return A.ioore(payload, 3);
          t2 = new A.RunBeforeOpen(new A.OpeningDetails(t1, t2), A._asInt(A._asDouble(payload[3])));
          t1 = t2;
          break $label0$0;
        }
        if (8 === tag) {
          t1 = B.JSArray_methods.skip$1(payload, 1);
          t2 = t1.$ti;
          t3 = t2._eval$1("MappedListIterable<ListIterable.E,TableUpdate>");
          t1 = A.List_List$_of(new A.MappedListIterable(t1, t2._eval$1("TableUpdate(ListIterable.E)")._as(new A.WebProtocol__deserializeRequest_closure()), t3), t3._eval$1("ListIterable.E"));
          t1 = new A.NotifyTablesUpdated(t1);
          break $label0$0;
        }
        t1 = A.throwExpression(A.ArgumentError$("Unknown request tag " + tag, _null));
      }
      return t1;
    },
    _serializeResponse$1(response) {
      var t1, message;
      $label0$0: {
        t1 = null;
        if (response == null)
          break $label0$0;
        if (response instanceof A.PrimitiveResponsePayload) {
          message = response.message;
          t1 = A._isBool(message) ? message : A._asInt(message);
          break $label0$0;
        }
        if (response instanceof A.SelectResult) {
          t1 = this._serializeSelectResult$1(response);
          break $label0$0;
        }
      }
      return t1;
    },
    _serializeSelectResult$1(result) {
      var columns, rows, jsRow,
        t1 = type$.SelectResult._as(result).rows,
        t2 = J.getInterceptor$asx(t1);
      if (t2.get$isEmpty(t1)) {
        t1 = init.G;
        t2 = type$.JSArray_nullable_Object;
        return {c: t2._as(new t1.Array()), r: t2._as(new t1.Array())};
      } else {
        columns = J.map$1$1$ax(t2.get$first(t1).get$keys(), new A.WebProtocol__serializeSelectResult_closure(), type$.String).toList$0(0);
        rows = A._setArrayType([], type$.JSArray_JSArray_nullable_Object);
        for (t1 = t2.get$iterator(t1); t1.moveNext$0();) {
          jsRow = [];
          for (t2 = J.get$iterator$ax(t1.get$current().get$values()); t2.moveNext$0();)
            jsRow.push(this._web_protocol$_encodeDbValue$1(t2.get$current()));
          B.JSArray_methods.add$1(rows, jsRow);
        }
        return {c: columns, r: rows};
      }
    },
    _deserializeResponse$1(response) {
      var t1, t2, t3, columns, rows, t4, dartRow, t5, t6, t7, i;
      if (response == null)
        return null;
      else if (typeof response === "boolean")
        return new A.PrimitiveResponsePayload(A._asBool(response));
      else if (typeof response === "number")
        return new A.PrimitiveResponsePayload(A._asInt(A._asDouble(response)));
      else {
        A._asJSObject(response);
        t1 = type$.JSArray_nullable_Object;
        t2 = t1._as(response.c);
        t2 = type$.List_String._is(t2) ? t2 : new A.CastList(t2, A._arrayInstanceType(t2)._eval$1("CastList<1,String>"));
        t3 = type$.String;
        t2 = J.map$1$1$ax(t2, new A.WebProtocol__deserializeResponse_closure(), t3);
        columns = A.List_List$_of(t2, t2.$ti._eval$1("ListIterable.E"));
        rows = A._setArrayType([], type$.JSArray_Map_of_String_and_nullable_Object);
        t1 = t1._as(response.r);
        t1 = J.get$iterator$ax(type$.List_JSArray_nullable_Object._is(t1) ? t1 : new A.CastList(t1, A._arrayInstanceType(t1)._eval$1("CastList<1,JSArray<Object?>>")));
        t2 = type$.nullable_Object;
        while (t1.moveNext$0()) {
          t4 = t1.get$current();
          dartRow = A.LinkedHashMap_LinkedHashMap$_empty(t3, t2);
          t4 = A.IndexedIterable_IndexedIterable(t4, 0, t2);
          t5 = J.get$iterator$ax(t4.__internal$_source);
          t6 = t4._start;
          t4 = new A.IndexedIterator(t5, t6, A._instanceType(t4)._eval$1("IndexedIterator<1>"));
          while (t4.moveNext$0()) {
            t7 = t4.__internal$_index;
            t7 = t7 >= 0 ? new A._Record_2(t6 + t7, t5.get$current()) : A.throwExpression(A.IterableElementError_noElement());
            i = t7._0;
            if (!(i >= 0 && i < columns.length))
              return A.ioore(columns, i);
            dartRow.$indexSet(0, columns[i], this._web_protocol$_decodeDbValue$1(t7._1));
          }
          B.JSArray_methods.add$1(rows, dartRow);
        }
        return new A.SelectResult(rows);
      }
    },
    _web_protocol$_encodeDbValue$1(value) {
      var t1;
      $label0$0: {
        if (value == null) {
          t1 = null;
        ...
        if (typeof value == "number") {
          t1 = A._setArrayType([15, value], type$.JSArray_double);
          break $label0$0;
        }
        if (value instanceof A._BigIntImpl) {
          t1 = A._setArrayType([14, value.toString$0(0)], type$.JSArray_Object);
          break $label0$0;
        }
        if (type$.List_int._is(value)) {
          t1 = new Uint8Array(A._ensureNativeList(value));
          break $label0$0;
        }
        t1 = A.throwExpression(A.ArgumentError$("Unknown db value: " + A.S(value), null));
      }
      return t1;
    },
    _web_protocol$_decodeDbValue$1(value) {
      var t1, tag, payload, _null = null;
      if (value != null)
        if (typeof value === "number")
        ...
        else if (A.JSAnyUtilityExtension_instanceOfString(value, "Uint8Array"))
          return type$.NativeUint8List._as(value);
        else {
          type$.JSArray_nullable_Object._as(value);
          t1 = value.length === 2;
          if (t1) {
            if (0 < 0 || 0 >= value.length)
              return A.ioore(value, 0);
            tag = value[0];
            if (1 < 0 || 1 >= value.length)
          ...
          if (tag == 14)
            return A._BigIntImpl_parse(A._asString(payload), _null);
          else
            return A._asDouble(payload);
        }
      else
        return _null;
    },
    _decodeStackStrace$1(stackTrace) {
      var t1,
        _0_0 = stackTrace != null ? A._asString(stackTrace) : null;
      $label0$0: {
        if (_0_0 != null) {
          t1 = new A._StringStackTrace(_0_0);
          break $label0$0;
        }
        t1 = null;
        break $label0$0;
    ...
    _decodeSqliteErrorResponse$1(array) {
      var requestId, t2, t3, t4, _null = null,
        t1 = array.length >= 8,
        stackTrace = _null,
        message = _null,
        explanation = _null,
        extendedResultCode = _null,
        operation = _null,
        causingStatement = _null,
        parametersToStatement = _null;
      if (t1) {
        if (0 < 0 || 0 >= array.length)
          return A.ioore(array, 0);
        requestId = array[0];
        if (1 < 0 || 1 >= array.length)
          return A.ioore(array, 1);
        stackTrace = array[1];
        if (2 < 0 || 2 >= array.length)
          return A.ioore(array, 2);
        message = array[2];
        if (3 < 0 || 3 >= array.length)
          return A.ioore(array, 3);
        explanation = array[3];
        if (4 < 0 || 4 >= array.length)
          return A.ioore(array, 4);
        extendedResultCode = array[4];
        if (5 < 0 || 5 >= array.length)
          return A.ioore(array, 5);
        operation = array[5];
        if (6 < 0 || 6 >= array.length)
          return A.ioore(array, 6);
        causingStatement = array[6];
        if (7 < 0 || 7 >= array.length)
          return A.ioore(array, 7);
        parametersToStatement = array[7];
      } else
        requestId = _null;
      if (!t1)
        throw A.wrapException(A.StateError$("Pattern matching error"));
      requestId = A._asInt(A._asDouble(requestId));
      extendedResultCode = A._asInt(A._asDouble(extendedResultCode));
      A._asString(message);
      t1 = explanation != null ? A._asString(explanation) : _null;
      t2 = causingStatement != null ? A._asString(causingStatement) : _null;
      if (parametersToStatement != null) {
        t3 = [];
        type$.JSArray_nullable_Object._as(parametersToStatement);
        t4 = B.JSArray_methods.get$iterator(parametersToStatement);
        while (t4.moveNext$0())
          t3.push(this._web_protocol$_decodeDbValue$1(t4.get$current()));
      } else
        t3 = _null;
      t4 = operation != null ? A._asString(operation) : _null;
      return new A.ErrorResponse(requestId, new A.SqliteException(message, t1, extendedResultCode, _null, t4, t2, t3), this._decodeStackStrace$1(stackTrace));
    }
  };
  A.WebProtocol_deserialize_decodeRequest.prototype = {
    call$0() {
      var serialized = A._asJSObject(this._box_0.payload);
      return new A.Request(A._asInt(serialized.i), this.$this._deserializeRequest$1(serialized.p));
    },
    $signature: 21
  };
  ...
  A.WebProtocol__deserializeRequest_readBatched.prototype = {
    call$0() {
      var sqlStatements, t5, t6, t7, t8, t9, t10,
        t1 = this.dartList,
        t2 = J.getInterceptor$asx(t1),
        t3 = type$.JSArray_nullable_Object,
        t = t3._as(t2.$index(t1, 1)),
        t4 = type$.List_String._is(t) ? t : new A.CastList(t, A._arrayInstanceType(t)._eval$1("CastList<1,String>"));
      t4 = J.map$1$1$ax(t4, new A.WebProtocol__deserializeRequest_readBatched_closure(), type$.String);
      sqlStatements = A.List_List$_of(t4, t4.$ti._eval$1("ListIterable.E"));
      t4 = t2.get$length(t1);
      t5 = A._setArrayType([], type$.JSArray_ArgumentsForBatchedStatement);
      for (t4 = t2.skip$1(t1, 2).take$1(0, t4 - 3), t3 = A.CastIterable_CastIterable(t4, t4.$ti._eval$1("Iterable.E"), t3), t4 = A._instanceType(t3), t4 = A.MappedIterable_MappedIterable(t3, t4._eval$1("List<Object?>(Iterable.E)")._as(new A.WebProtocol__deserializeRequest_readBatched_closure0()), t4._eval$1("Iterable.E"), type$.List_nullable_Object), t3 = t4.__internal$_iterable, t6 = A._instanceType(t4), t4 = new A.MappedIterator(t3.get$iterator(t3), t4._f, t6._eval$1("MappedIterator<1,2>")), t3 = this.$this.get$_web_protocol$_decodeDbValue(), t6 = t6._rest[1]; t4.moveNext$0();) {
        t7 = t4.__internal$_current;
        if (t7 == null)
          t7 = t6._as(t7);
        t8 = J.getInterceptor$asx(t7);
        t9 = A._asInt(A._asDouble(t8.$index(t7, 0)));
        t7 = t8.skip$1(t7, 1);
        t8 = t7.$ti;
        t10 = t8._eval$1("MappedListIterable<ListIterable.E,Object?>");
        t7 = A.List_List$_of(new A.MappedListIterable(t7, t8._eval$1("Object?(ListIterable.E)")._as(t3), t10), t10._eval$1("ListIterable.E"));
        t5.push(new A.ArgumentsForBatchedStatement(t9, t7));
      }
      t1 = t2.$index(t1, t2.get$length(t1) - 1);
  ...
  A.WebProtocol__deserializeRequest_readBatched_closure0.prototype = {
    call$1(e) {
  ...
  A.WebProtocol__deserializeRequest_closure.prototype = {
    call$1(e) {
      ...
      if (kindOrNull == null)
        ...
        kindOrNull = A._asInt(A._asDouble(kindOrNull));
        if (!(kindOrNull >= 0 && kindOrNull < 3))
          return A.ioore(B.List_L4j, kindOrNull);
        t1 = B.List_L4j[kindOrNull];
      }
  ...
  A.WebProtocol__deserializeResponse_closure.prototype = {
    call$1(e) {
      return A._asString(e);
    },
    $signature: 2
  ...
  A.runCancellable_closure.prototype = {
    call$0() {
      return this._box_0.token._resultCompleter.complete$1(A.Future_Future$sync(this.operation, this.T));
    },
    $signature: 0
  };
  A.CancellationToken.prototype = {
    cancel$0() {
      ...
      if (this._cancellationRequested)
        return;
      for (t1 = this._cancellationCallbacks, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        t1[_i].call$0();
  ...
  A.WebPortToChannel_channel_closure.prototype = {
    call$1($event) {
      var t1, _this = this, _s6_ = "_local", _s5_ = "_sink",
        message = A._asJSObject($event).data;
      if (_this.explicitClose && J.$eq$(message, "_disconnect")) {
        ...
        t1 = _this.controller.__StreamChannelController__local_F;
        if (_this.webNativeSerialization) {
          t1 === $ && A.throwLateFieldNI(_s6_);
          t1 = t1.__GuaranteeChannel__sink_F;
          t1 === $ && A.throwLateFieldNI(_s5_);
          t1.add$1(0, _this.protocol.deserialize$1(type$.JSArray_nullable_Object._as(message)));
        } else {
          t1 === $ && A.throwLateFieldNI(_s6_);
          t1 = t1.__GuaranteeChannel__sink_F;
          t1 === $ && A.throwLateFieldNI(_s5_);
  ...
  A.WebPortToChannel_channel_closure0.prototype = {
    call$1(e) {
      var t1 = this._this;
      if (this.webNativeSerialization)
        t1.postMessage(this.protocol.serialize$1(type$.Message._as(e)));
      else
        t1.postMessage(A.jsify(e));
    },
    $signature: 3
  };
  ...
  A._RunningDriftWorker.prototype = {
    start$0() {
      var t2,
        t1 = init.G;
      if (this.isShared)
        A._EventStreamSubscription$(t1, "connect", type$.nullable_void_Function_JSObject._as(this.get$_newConnection()), false, type$.JSObject);
      else {
    ...
    _newConnection$1($event) {
      var t1 = {},
        ...
        originalChannel = A.WebPortToChannel_channel(outgoingPort, false, 0, false);
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (message != null && A.JSAnyUtilityExtension_instanceOfString(message, "MessagePort")) {
                ...
                server.serve$1(A.WebPortToChannel_channel(A._asJSObject(message), false, 0, false));
              } else
  ...
  A._RunningDriftWorker__newConnection_remainingChannel.prototype = {
    call$0() {
      var t1 = this.originalChannel,
        t2 = t1.$ti,
        t3 = t2._eval$1("Stream<1>(Stream<1>)")._as(new A._RunningDriftWorker__newConnection_remainingChannel_closure(this._box_0)).call$1(t1.get$stream()),
        t4 = new A.CloseGuaranteeChannel(t2._eval$1("CloseGuaranteeChannel<1>")),
        t5 = t2._eval$1("_CloseGuaranteeSink<1>");
      t4.__CloseGuaranteeChannel__sink_F = t5._as(new A._CloseGuaranteeSink(t4, t1.get$sink(), t5));
      t2 = t2._eval$1("_CloseGuaranteeStream<1>");
      t4.__CloseGuaranteeChannel__stream_F = t2._as(new A._CloseGuaranteeStream(t3, t4, t2));
      return t4;
    },
    $signature: 41
  };
  A._RunningDriftWorker__newConnection_remainingChannel_closure.prototype = {
    call$1(__wc0_formal) {
      var t2,
        t1 = this._box_0.subscription;
      t1.toString;
      t2 = new A.SubscriptionStream(t1, type$.SubscriptionStream_nullable_Object);
      t2.SubscriptionStream$1(t1, type$.nullable_Object);
      return t2;
    },
    $signature: 42
  };
  A._RunningDriftWorker__newConnection_closure.prototype = {
    call$1(first) {
      var server, worker, _this = this, _s5_ = "_sink",
        expectedMode = A.EnumByName_byName(B.List_2n2, A._asString(first), type$.DriftWorkerMode),
        t1 = _this.$this,
        t2 = t1._knownMode;
      if (t2 == null)
        switch (expectedMode.index) {
          ...
          case 2:
            ...
            worker = A._asJSObject(new init.G.Worker(A.Uri_base().toString$0(0)));
            t1._dedicatedWorker = worker;
  ...
  A.main_closure.prototype = {
    call$0() {
      return A.driftDatabase("marksmanmate_db", null, null);
    },
    $signature: 54
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 59, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 63, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 64, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 65, 0);
    ...
    _static_1(A, "async___printToZone$closure", "_printToZone0", 68);
    ...
    _instance(_, "get$addError", 0, 1, null, ["call$2", "call$1"], ["addError$2", "addError$1"], 30, 0, 0);
    ...
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 8);
    _instance_1_u(A.WebProtocol.prototype, "get$_web_protocol$_decodeDbValue", "_web_protocol$_decodeDbValue$1", 8);
    _instance_1_u(_ = A._RunningDriftWorker.prototype, "get$_newConnection", "_newConnection$1", 10);
    _instance_1_u(_, "get$_handleMessage", "_handleMessage$1", 3);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.TakeIterable, A.SkipIterable, A.SkipWhileIterable, A.WhereTypeIterable, A.IndexedIterable, A._AllMatchesIterable, A._StringAllMatchesIterable]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Instantiation, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._SyncBroadcastStreamController__sendData_closure, A._SyncBroadcastStreamController__sendDone_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.Stream_firstWhere_closure0, A.Stream_firstWhere__closure0, A._CustomZone_bindUnaryCallback_closure, A._CustomZone_bindUnaryCallbackGuarded_closure, A._RootZone_bindUnaryCallback_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._HashMap_values_closure, A._BigIntImpl_hashCode_finish, A._Uri__makePath_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A.DriftCommunication_setRequestHandler_closure, A.DriftProtocol_decodePayload_readInt, A.DriftProtocol_decodePayload_readNullableInt, A.ServerImplementation_closure, A.ServerImplementation_serve_closure, A.ServerImplementation_serve_closure0, A.ServerImplementation__waitForTurn_closure, A.WebProtocol__serializeRequest_closure, A.WebProtocol__deserializeRequest_readBatched_closure, A.WebProtocol__deserializeRequest_readBatched_closure0, A.WebProtocol__deserializeRequest_closure, A.WebProtocol__serializeSelectResult_closure, A.WebProtocol__deserializeResponse_closure, A.WebPortToChannel_channel_closure, A.WebPortToChannel_channel_closure0, A._RunningDriftWorker_start_closure, A._RunningDriftWorker__newConnection_remainingChannel_closure, A._RunningDriftWorker__newConnection_closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.WindowsStyle_absolutePathToUri_closure, A.SqliteException_toString_closure, A.Chain_Chain$parse_closure, A.Chain_toTrace_closure, A.Chain_toString_closure0, A.Chain_toString__closure0, A.Chain_toString_closure, A.Chain_toString__closure, A.Trace__parseVM_closure, A.Trace$parseV8_closure, A.Trace$parseJSCore_closure, A.Trace$parseFirefox_closure, A.Trace$parseFriendly_closure, A.Trace_toString_closure0, A.Trace_toString_closure, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._TimerImpl$periodic_closure, A.Future_Future$delayed_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainCoreFuture_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteErrorObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A.Stream_firstWhere_closure, A.Stream_firstWhere__closure, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendError_sendError, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._cancelAndError_closure, A._cancelAndValue_closure, A._CustomZone_bindCallback_closure, A._CustomZone_bindCallbackGuarded_closure, A._RootZone_bindCallback_closure, A._RootZone_bindCallbackGuarded_closure, A._rootHandleError_closure, A._Utf8Decoder__decoder_closure, A._Utf8Decoder__decoderNonfatal_closure, A._CancelOnErrorSubscriptionWrapper_onError__closure, A.DriftCommunication_closure, A.ServerImplementation__handleRequest_closure, A.ServerImplementation__handleRequest_closure0, A.ServerImplementation__waitForTurn_idIsActive, A.WebProtocol_deserialize_decodeRequest, A.WebProtocol_deserialize_decodeSuccess, A.WebProtocol__deserializeRequest_readBatched, A.runCancellable_closure, A.WebPortToChannel_channel_closure1, A._RunningDriftWorker__establishModeAndLaunchServer_closure, A._RunningDriftWorker__newConnection_remainingChannel, A.Frame_Frame$parseVM_closure, A.Frame_Frame$parseV8_closure, A.Frame_Frame$_parseFirefoxEval_closure, A.Frame_Frame$parseFirefox_closure, A.Frame_Frame$parseFriendly_closure, A.Trace_Trace$from_closure, A.GuaranteeChannel_closure, A.GuaranteeChannel__closure, A.main_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "String(String)", "~(Object?)", "Null()", "Frame()", "Frame(String)", "~(@)", "Object?(Object?)", "~(Object,StackTrace)", "~(JSObject)", "~(~())", "Null(Object,StackTrace)", "Null(@)", "@()", "int(int)", "bool(~)", "bool()", "int(Frame)", "String(Frame)", "Trace(String)", "Request()", "@(@)", "0&(String,int?)", "Future<~>()", "@(@,String)", "Future<~>(Request)", "int?(int)", "Null(~)", "ResponsePayload?/(Request)", "~(Object[StackTrace?])", "Future<ResponsePayload?>()", "CancellationToken<@>?()", "~(@,StackTrace)", "SuccessResponse()", "ExecuteBatchedStatement()", "~(@,@)", "TableUpdate(Object?)", "Null(JSObject)", "@(String)", "Object?(JSObject)", "StreamChannel<Object?>()", "SubscriptionStream<Object?>(Stream<Object?>)", "Null(@,StackTrace)", "String(String?)", "String(Object?)", "List<Frame>(Trace)", "int(Trace)", "0^(0^,0^)<num>", "String(Trace)", "~(Object?,Object?)", "Null(bool)", "Frame(String,String)", "Trace()", "QueryExecutor()", "int(int,int)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Null(~())", "~(int,@)", "List<Object?>(JSArray<Object?>)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      SqliteException: findType("SqliteException"),
...
;
    ...
    B.List_2n2 = makeConstList([B.DriftWorkerMode_0, B.DriftWorkerMode_1, B.DriftWorkerMode_2], A.findType("JSArray<DriftWorkerMode>"));
    ...
    B.SqlDialect_3_duckdb = new A.SqlDialect(3, "duckdb");
    B.SqlDialect_4_mariadb = new A.SqlDialect(4, "mariadb");
    B.List_nVg = makeConstList([B.SqlDialect_0_sqlite, B.SqlDialect_1_mysql, B.SqlDialect_2_postgres, B.SqlDialect_3_duckdb, B.SqlDialect_4_mariadb], A.findType("JSArray<SqlDialect>"));
    ...
    B.List_empty0 = makeConstList([], type$.JSArray_Map_of_String_and_nullable_Object);
    B.SelectResult_List_empty = new A.SelectResult(B.List_empty0);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_v8JsFrame", "$get$_v8JsFrame", () => A.RegExp_RegExp("^\\s*at (?:(\\S.*?)(?: \\[as [^\\]]+\\])? \\((.*)\\)|(.*))$", true, false, false, false));
    _lazyFinal($, "_v8JsUrlLocation", "$get$_v8JsUrlLocation", () => A.RegExp_RegExp("^(.*?):(\\d+)(?::(\\d+))?$|native$", true, false, false, false));
    _lazyFinal($, "_v8WasmFrame", "$get$_v8WasmFrame", () => A.RegExp_RegExp("^\\s*at (?:(?<member>.+) )?(?:\\(?(?:(?<uri>\\S+):wasm-function\\[(?<index>\\d+)\\]\\:0x(?<offset>[0-9a-fA-F]+))\\)?)$", true, false, false, false));
    ...
    _lazyFinal($, "_firefoxSafariJSFrame", "$get$_firefoxSafariJSFrame", () => A.RegExp_RegExp("^(?:([^@(/]*)(?:\\(.*\\))?((?:/[^/]*)*)(?:\\(.*\\))?@)?(.*?):(\\d*)(?::(\\d*))?$", true, false, false, false));
    _lazyFinal($, "_firefoxWasmFrame", "$get$_firefoxWasmFrame", () => A.RegExp_RegExp("^(?<member>.*?)@(?:(?<uri>\\S+).*?:wasm-function\\[(?<index>\\d+)\\]:0x(?<offset>[0-9a-fA-F]+))$", true, false, false, false));
    _lazyFinal($, "_safariWasmFrame", "$get$_safariWasmFrame", () => A.RegExp_RegExp("^.*?wasm-function\\[(?<member>.*)\\]@\\[wasm code\\]$", true, false, false, false));
